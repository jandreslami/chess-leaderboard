...
class JugadorEnLeaderboard extends Jugador {
  constructor(username, nombre, titulo, pais, seguidores, imagenPerfil, enlacePerfil, posicionEnLeaderboard, rating, partidasGanadas = 0, partidasPerdidas = 0, partidasTablas = 0) {
